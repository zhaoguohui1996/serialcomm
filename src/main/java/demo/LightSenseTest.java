 ...
 * @description
 * @author: zgh
 * @create: 2020-05-11 15:23
 **/
@Data
public class LightSenseTest {
    ////////////////默认值////////////////////
    /**
     * 串口号
     */
    ...
    private void getIllumination(String deviceAddress) throws InterruptedException {
        /** 查1# 设备 1个数据*/
        /** 设备地址 */
        ...
        while (true) {
            ...
            if (s1.replace(" ", "").equalsIgnoreCase(rcrc)) {
                ...
                double illuminance = Integer.parseInt(dataLength, 16);
                System.out.println("光照为:" + String.format("%.2f", illuminance) + "Lux");
            }
            Thread.sleep(5000);
        }
    }
